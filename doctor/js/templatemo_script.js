...
jQuery(function($) {
        ...
        top_menu_height = $('.div-top-menu').height();
        // scroll spy to auto active the nav item
        $('body').scrollspy({ target: '#main-nav-bar', offset: top_menu_height + 10 });
		$('.external-link').unbind('click');
        ...
        $('.div-top-menu .navbar-nav a').click(function(e){
            e.preventDefault(); 
